  ...
  return (
    <div className="card">
      ...
      <div style={{ padding: '24px' }}>
        <h2 className="card-title">Sistema de Badges</h2>
        <div className="card-content">
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: '14px', lineHeight: '1.6', color: '#333333', marginBottom: '8px' }}>
              <strong>Requisito:</strong> Completar todos os 5 tutoriais da classe 1 (Os primeiros passos para se tornar Creator)
            </p>
            <p style={{ fontSize: '14px', lineHeight: '1.6', color: '#666666' }}>
